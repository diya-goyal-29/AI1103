...
\resizebox{\columnwidth}{!}{
    \begin{tabular}{|c|c|}
        \hline
         $n$ = Total number of coins & 2\\
         \hline
        The total no. of outcomes & 4\\ 
        \hline
        $p$ = probability of head & $\frac{1}{2}$\\
        \hline
...
Probability of at least one head
    \begin{align}
         &= {Pr(X = 1)} + {Pr(X = 2)} \\
         &= {^2 C _1}\left({p}\right)\left({q}\right) + {^2 C _2}\left({p^2}\right)\\
         &= {^2 C _1} \left( {\frac{1}{2}}\right) \left( {\frac{1}{2}}\right) + {^2 C _2} \left(\frac{1}{2}\right) ^2\\ 
         &= 2 \left(\frac{1}{4}\right) + \frac{1}{4}\\
         &= \frac{3}{4}\\
         &= 0.75
    \end{align}
