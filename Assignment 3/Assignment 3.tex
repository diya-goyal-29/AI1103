...
\end{lstlisting}
\large \textbf{CSIR-UGC-NET-Exam-JUNE-2015 Question 60 :}\\
...
\begin{align}
    E[N] = \sum ^\infty _{n = 0} P(N > n) = \sum ^\infty _{n = 0} P(S_n \leq 1)
\end{align}
$S_n$ follows Erlang distribution.\\
\begin{align}
    \text{P.D.F of }S_n =\frac{\lambda^{n+1} x^{n}e^{-\lambda x}}{(n)!}\\
    P(S_n \leq 1) = \int _0 ^1 \frac{\lambda^{n+1} x^{n}e^{-\lambda x}}{(n)!} dx
\end{align}
Substituting the value in equation 0.0.1\\
\begin{align}
    E[N] &= \sum _{n = 0} ^\infty \int _0 ^1  \frac{\lambda^{n+1} x^{n}e^{-\lambda x}}{(n)!} dx\\
    &= \int _0 ^1 \sum _{n = 0} ^\infty \frac{\lambda^{n+1} x^{n}e^{-\lambda x}}{(n)!} dx\\
    e^{x\lambda} &= \sum _{n = 0} ^ \infty\frac{(x\lambda)^n}{(n)!}\\
    E[N] &=\lambda  \int _0 ^1 e^{\lambda x} e^{-\lambda x} dx\\
    &= \lambda \int _0 ^1 dx\\
    &= \lambda
\end{align}
\begin{align}
    E[N^2] &= \sum _{n = 0} ^\infty P(N^2 \geq n)\\
    &= \sum _{n = 0} ^\infty [(n+1)^2 - n^2] P(N \geq n)\\
    &= \sum _{n = 0} ^\infty [2n + 1] P(S_{n+1} \leq 1)\\
